<div class="container">
  <div class="row">
    ...
    <?php 
      ...
      if(isset($_GET['grade'])){
          $stmt = $db->prepare("SELECT quiz.id, quiz.title, quiz.pageInfo FROM quiz JOIN weeklywork ON quiz.wwid = weeklywork.id WHERE weeklywork.grade = ? ORDER BY quiz.startdate");
